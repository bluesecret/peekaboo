...
<template>
  ...
  >
    ...
    <a-form :model="form" :auto-label-width="true">
      ...
      <a-form-item
        :label="$t('sys.watermarkOpen')"
        :help="$t('sys.watermarkOpenHelp')"
      >
        <a-switch v-model="form.watermarkOpen" @change="handleWaterMarkOpen" />
      </a-form-item>
      <a-form-item
...
const form = reactive({
  ...
  i18n: appStore.i18n,
  watermarkOpen: appStore.watermarkOpen,
});
...
const handleWaterMarkOpen = (val) => appStore.toggleWatermark(val);
