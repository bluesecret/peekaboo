<!--
 * @Author: wangyuanjie
 * @Date: 2024-03-28 15:54:04
 * @LastEditTime: 2024-03-28 15:55:17
  ...
  <div id="tableHeaderContainer" class="relative" :style="{ zIndex: 9 }">
    <a-card :title="title" size="small" :bordered="isBordered">
      <template #extra v-if="showFilter">
        <a-space>
          <a-button type="primary" size="small" @click="doSearch"
            >搜索</a-button
          >
          <a-button status="danger" size="small" @click="doResetSearch"
            >重置</a-button
          >
        </a-space>
      </template>
