...
import io.wangk.tiny.common.exception.StatusException;
...
import io.wangk.tiny.component.web.core.response.api.ValidationStatusCode;
...
public class DefaultValidationExceptionAdvice extends AbstractControllerAdvice
    ...
    private ValidationStatusCode findValidationStatusCode(BindException e) {
        ...
        try {
            ...
            throw new StatusException("获得校验不通过的属性失败,fieldName={}", fieldName, exception);
        }
    ...
    private Method currentControllerMethod() {
        try {
            ...
            throw new StatusException("获取当前Controller方法失败", e);
        }
    }
