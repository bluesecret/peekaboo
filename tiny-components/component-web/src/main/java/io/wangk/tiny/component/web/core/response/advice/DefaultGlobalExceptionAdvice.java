package io.wangk.tiny.component.web.core.response.advice;

import io.wangk.tiny.component.web.core.response.ExceptionAliasRegister;
import io.wangk.tiny.component.web.core.response.ResponseProperties;
import io.wangk.tiny.component.web.core.response.advice.lifecycle.exception.ControllerAdviceHttpProcessor;
import io.wangk.tiny.component.web.core.response.advice.lifecycle.exception.ControllerAdvicePredicate;
import io.wangk.tiny.component.web.core.response.advice.lifecycle.exception.ControllerAdviceProcessor;
import io.wangk.tiny.component.web.core.response.api.ExceptionAliasFor;
import io.wangk.tiny.component.web.core.response.api.ExceptionMapper;
import io.wangk.tiny.component.web.core.response.api.ResponseFactory;
import io.wangk.tiny.component.web.core.response.api.ResponseStatusFactory;
import io.wangk.tiny.component.web.core.response.data.ExceptionAliasConfig;
import io.wangk.tiny.component.web.core.response.data.Response;
import io.wangk.tiny.component.web.core.response.data.ResponseStatus;
